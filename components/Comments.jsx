...
const Comments = ({ dataPost, handleModalComment }) => {
  ...
  return (
    ...
    >
      <div className={`${comments.length>4?"h-[20rem]":"h-auto"} overflow-scroll no-scrollbar my-5`}>
      ...
      <AddData type="comment" setRender={setRender} render={render} idPost={dataPost.id} />
    </Modal>
  );
};
