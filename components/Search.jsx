  ...
  return (
    <nav className="fixed">
      <div  className="h-[4rem] px-10 py-2  bg-black flex justify-center items-center">
        <div className="flex items-center justify-center gap-2 px-5 group focus-within:border-blue-500 focus-within:border-[0.005rem] focus-within:bg-transparent bg-zinc-800 w-[22rem] rounded-full h-full">
          <input
            type="text"
